...
class AdminProjectCard extends StatelessWidget {
  ...
  final ProjectsManagerController
  controller; // ✅ نستقبل الكونترولر من الصفحة الأم
      ...
      child: Row(
        ...
        children: [
          ...
          _AdminActionButton(
            ...
            onTap: () {
              final dataController = Provider.of<ProjectsController>(
                context,
                listen: false,
              );
              controller.toggleProjectFreeze(context, project, dataController);
            },
          ),
...
// (ويدجت _AdminActionButton تبقى كما هي)
