...
import 'package:iep_app/mvc/views/auth/blocked_user_screen.dart';
...
class LoginController extends ChangeNotifier {
  ...
  forgetPassword(BuildContext context) async {
    ...
    try {
      await _repository.resetPassword(emailController.text);
      if (!context.mounted) return; //check user not change the page
  ...
  void onCreateEmailTap(BuildContext context) {
    Navigator.push(
      context,
