...
class AdminUserCard extends StatelessWidget {
  ...
  Color _getRoleColor(String role, AppColorScheme colors) {
    // بما أننا مررنا الـ role بحروف صغيرة (lowercase) من الصفحة السابقة
    // يجب أن نقارن هنا أيضاً بحروف صغيرة
    switch (role) {
      case 'admin':
        return colors.primary; // لون مميز للأدمن
      case 'municipality':
        return Colors.orange; // لون مميز للبلدية
      default:
        return colors.secText; // لون رمادي للمستخدم العادي
    }
  }
}
