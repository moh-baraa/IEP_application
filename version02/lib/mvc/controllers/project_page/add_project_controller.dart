...
class AddProjectController {
  ...
  void initializeForEdit(ProjectModel project) {
    ...
    amountController.text = (project.targetFunds ?? 0).toStringAsFixed(
      0,
  ...
  Future<void> submit(BuildContext context, GlobalKey<FormState> key) async {
    ...
    try {
      ...
      final String currentUserId =
          FirebaseAuth.instance.currentUser!.uid; // and the id
      ...
      if (isEditMode && existingProjectId != null) {
        ...
        DocumentReference docRef = await _repo.addNewProject(data: projectData);
        ...
        NotificationService.sendAdminNotification(
          ...
          relatedIdKey: 'projectId',// what is the id key will be in the document
        );
